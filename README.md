...
⚠ 現在、ストアにアップしてるバーションは github の変更に追従していない為、正常稼働しません。また、このリポジトリ上のモノも最新の依存パッケージおよびフレームワークの組み合わせではビルドが通らない問題を抱えています。 → iOS 版および Android 版はビルドできるようになりました。( Android 版については開発環境によってビルドが通ったり通らなかったりといった問題が確認されてます )
